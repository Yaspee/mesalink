...
enum AlgorithmID {
    ...
    ECDSA_SM2_SM3_ASN1_SIGNING,
    ECDSA_SM2_SM3_FIXED_SIGNING,
    ECDSA_SM2_SHA256_ASN1_SIGNING,
    ECDSA_SM2_SHA256_FIXED_SIGNING,
}
...
/// Signing of ASN.1 DER-encoded ECDSA signatures using the P-SM2 curve and
/// SM3.
///
/// See "`ECDSA_*_ASN1` Details" in `ring::signature`'s module-level
/// documentation for more details.
pub static ECDSA_SM2_SM3_ASN1_SIGNING: Algorithm = Algorithm {
    curve: &ec::suite_b::curve::SM2,
    private_scalar_ops: &sm2::PRIVATE_SCALAR_OPS,
    private_key_ops: &sm2::PRIVATE_KEY_OPS,
    digest_alg: &digest::SM3,
    pkcs8_template: &EC_PUBLIC_KEY_SM2_PKCS8_V1_TEMPLATE,
    format_rs: format_rs_asn1,
    id: AlgorithmID::ECDSA_SM2_SM3_ASN1_SIGNING,
};
...
/// See "`ECDSA_*_ASN1` Details" in `ring::signature`'s module-level
/// documentation for more details.
pub static ECDSA_SM2_SHA256_ASN1_SIGNING: Algorithm = Algorithm {
    curve: &ec::suite_b::curve::SM2,
    private_scalar_ops: &sm2::PRIVATE_SCALAR_OPS,
    private_key_ops: &sm2::PRIVATE_KEY_OPS,
    digest_alg: &digest::SHA256,
    pkcs8_template: &EC_PUBLIC_KEY_SM2_PKCS8_V1_TEMPLATE,
    format_rs: format_rs_asn1,
    id: AlgorithmID::ECDSA_SM2_SHA256_ASN1_SIGNING,
};
...
/// See "`ECDSA_*_ASN1` Details" in `ring::signature`'s module-level
/// documentation for more details.
pub static ECDSA_SM2_SM3_FIXED_SIGNING: Algorithm = Algorithm {
    curve: &ec::suite_b::curve::SM2,
    private_scalar_ops: &sm2::PRIVATE_SCALAR_OPS,
    private_key_ops: &sm2::PRIVATE_KEY_OPS,
    digest_alg: &digest::SM3,
    pkcs8_template: &EC_PUBLIC_KEY_SM2_PKCS8_V1_TEMPLATE,
    format_rs: format_rs_asn1,
    id: AlgorithmID::ECDSA_SM2_SM3_FIXED_SIGNING,
};
...
/// See "`ECDSA_*_ASN1` Details" in `ring::signature`'s module-level
/// documentation for more details.
pub static ECDSA_SM2_SHA256_FIXED_SIGNING: Algorithm = Algorithm {
    curve: &ec::suite_b::curve::SM2,
    private_scalar_ops: &sm2::PRIVATE_SCALAR_OPS,
    private_key_ops: &sm2::PRIVATE_KEY_OPS,
    digest_alg: &digest::SHA256,
    pkcs8_template: &EC_PUBLIC_KEY_SM2_PKCS8_V1_TEMPLATE,
    format_rs: format_rs_asn1,
    id: AlgorithmID::ECDSA_SM2_SHA256_FIXED_SIGNING,
};
