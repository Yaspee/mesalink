...
suite_b_curve!(SM2, 256, &ec::suite_b::ops::sm2::PRIVATE_KEY_OPS,
               ec::CurveID::SM2P256, sm2p256_check_private_key_bytes,
               sm2p256_generate_private_key, sm2p256_public_from_private);