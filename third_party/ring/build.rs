...
const RING_SRCS: &'static [(&'static [&'static str], &'static str)] = &[
    ...
    (&[], "crypto/sm4/e_sm4.c"),
    (&[], "crypto/sm4/sm4.c"),
    (&[], "crypto/sm4/sms4_common.c"),
    (&[], "crypto/sm4/sms4_setkey.c"),
    ...
    (&[], "crypto/fipsmodule/ec/gfp_sm2.c"),
...
const RING_INCLUDES: &'static [&'static str] =
    &["crypto/fipsmodule/aes/internal.h",
      ...
      "crypto/fipsmodule/ec/ecp_sm2.inl",
      "crypto/fipsmodule/ec/ecp_nistz.h",
      "crypto/fipsmodule/ec/ecp_nistz384.h",
      "crypto/fipsmodule/ec/ecp_nistz256.h",
      "crypto/fipsmodule/ec/ecp_sm2.h",
      "crypto/internal.h",
      "crypto/limbs/limbs.h",
      "crypto/limbs/limbs.inl",
      "crypto/fipsmodule/modes/internal.h",
      "crypto/sm4/internal.h",
      "crypto/sm4/sms4_lcl.h",
      "include/GFp/aes.h",
      "include/GFp/sm4.h",
